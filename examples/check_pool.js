...
async function check_balance() {
  ...
  // res = await lendingPool.methods.getReserveConfigurationData(usdtAddr).call(options);
  // console.log("ReserveConfigurationData:");
  // console.log(res);
  res = await lendingPool.methods.getReserveData(usdtAddr).call(options);
  ...
  // console.log("USDT reserve: ")
  // // res = await lendingPool.methods.getReserveConfigurationData(linkAddr).call(options);
  // // console.log("ReserveConfigurationData:");
  // // console.log(res);
  // res = await lendingPool.methods.getReserveData(linkAddr).call(options);
  // // console.log("ReserveData:");
  // console.log(res);
