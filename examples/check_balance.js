...
async function check_balance() {
  ...
  // response = await lendingPool.methods.borrow(usdtAddr, 20000000, 1, 0).send(options);
  ...
  user = ownerAddr
  console.log("Balances of " + user + ":")
  response = await aLINKContract.methods.balanceOf(user).call(options);;
  console.log("aLINK balance: " + response / 1000000000000000000)

  response = await linkContract.methods.balanceOf(user).call(options)
    console.log("LINK balance: " + response / 1000000000000000000)

  response = await usdtContract.methods.balanceOf(user).call(options)
    console.log("USDT balance: " + response / 1000000)

  response = await aUSDTContract.methods.balanceOf(user).call(options);;
  console.log("aUSDT balance: " + response / 1000000)
